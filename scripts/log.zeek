...
event zeek_init() &priority=5
{
    ...
    add_log(LOG_M_IT_TB_1, [$columns=M_IT_TB_1_log, $path="iec104-M_IT_TB_1"], log_as_json);
    add_log(LOG_M_EP_TD_1, [$columns=M_EP_TD_1_log, $path="iec104-M_EP_TD_1"], log_as_json);
    add_log(LOG_M_EP_TE_1, [$columns=M_EP_TE_1_log, $path="iec104-M_EP_TE_1"], log_as_json);
    add_log(LOG_M_EP_TF_1, [$columns=M_EP_TF_1_log, $path="iec104-M_EP_TF_1"], log_as_json);
    ...
    add_log(LOG_C_CI_NA_1, [$columns=C_CI_NA_1_log, $path="iec104-C_CI_NA_1"], log_as_json);
    ...
    &priority=-5
{
    local rec = M_PS_NA_1_log(
        ...
        $apdu=c$apdu_counter,
        $type_id=M_PS_NA_1,
        $type_id_code=enum_to_int(M_PS_NA_1),
        $io=io);
    ...
    &priority=-5
{
    local rec = M_ME_ND_1_log(
        ...
        $apdu=c$apdu_counter,
        $type_id=M_ME_ND_1,
        $type_id_code=enum_to_int(M_ME_ND_1),
        $io=io);
    ...
    &priority=-5
{
    local rec = M_IT_TB_1_log(
        ...
        $apdu=c$apdu_counter,
        $type_id=M_IT_TB_1,
        $type_id_code=enum_to_int(M_IT_TB_1),
        $io=io);
    ...
    &priority=-5
{
    local rec = M_EP_TD_1_log(
        ...
        $apdu=c$apdu_counter,
        $type_id=M_EP_TD_1,
        $type_id_code=enum_to_int(M_EP_TD_1),
        $io=io);
    ...
    &priority=-5
{
    local rec = M_EP_TE_1_log(
        ...
        $apdu=c$apdu_counter,
        $type_id=M_EP_TE_1,
        $type_id_code=enum_to_int(M_EP_TE_1),
        $io=io);
    ...
    &priority=-5
{
    local rec = M_EP_TF_1_log(
        ...
        $apdu=c$apdu_counter,
        $type_id=M_EP_TF_1,
        $type_id_code=enum_to_int(M_EP_TF_1),
        $io=io);
    ...
    &priority=-5
{
    local rec = C_CI_NA_1_log(
        ...
        $apdu=c$apdu_counter,
        $type_id=C_CI_NA_1,
        $type_id_code=enum_to_int(C_CI_NA_1),
        $io=io);
    ...
    &priority=-5
{
    local rec = C_TS_TA_1_log(
        ...
        $apdu=c$apdu_counter,
        $type_id=C_TS_TA_1,
        $type_id_code=enum_to_int(C_TS_TA_1),
        $io=io);
    ...
    &priority=-5
{
    local rec = P_ME_NA_1_log(
        ...
        $apdu=c$apdu_counter,
        $type_id=P_ME_NA_1,
        $type_id_code=enum_to_int(P_ME_NA_1),
        $io=io);
    ...
    &priority=-5
{
    local rec = P_AC_NA_1_log(
        ...
        $apdu=c$apdu_counter,
        $type_id=P_AC_NA_1,
        $type_id_code=enum_to_int(P_AC_NA_1),
        $io=io);
